...
public class Main extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        matG.setColor("Color", ColorRGBA.Magenta); 
    ...
    public void simpleUpdate(float tpf) {
        ...
        **/
        ...
        rootNode.getChild("nodo_tierra").rotate(0,tpf, tpf);
        ...
        rootNode.getChild("nodo_pivoteMercurio").rotate(0, tpf/2, tpf/2);
        // lo velocidad en la que se mueve Venus
        rootNode.getChild("nodo_pivoteVenus").rotate(0, tpf/5, tpf/5);
